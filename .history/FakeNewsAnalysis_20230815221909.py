...
for i in range(len(fake)):
    ...
    fakeTitleProf[i] = profanity.contains_profanity(fakeTitle)
    ...
    fakeTextProf[i] = profanity.contains_profanity(fakeText)
    ...
    if i < len(real):
        ...
        realTitleProf[i] = profanity.contains_profanity(realTitle)
        ...
        realTextProf[i] = profanity.contains_profanity(realText)
